...
certbot certonly --manual --preferred-challenges dns -d $bucket
...
# note that Cloudfront certificates must be in us-east-1
...
echo aws cloudfront create-distribution --distribution-config file://$home/distribution.json 
